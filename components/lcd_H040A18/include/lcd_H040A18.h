...
}h040a18_vendor_config_t;

/**
 * @brief Create LCD panel for model h040a18
 *
 ...
 *
 */
#define H040A18_PANEL_IO_3WIRE_SPI_CONFIG(line_cfg,scl_active_edge) \
    {                                                               \    
