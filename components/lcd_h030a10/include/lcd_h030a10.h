...
}h030a10_vendor_config_t;

/**
 * @brief Create LCD panel for model h030a10
 *
 ...
 *
 */
#define H030A10_PANEL_IO_3WIRE_SPI_CONFIG(line_cfg,scl_active_edge) \
    {                                                               \    
